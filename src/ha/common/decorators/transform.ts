...
/**
 * Specifies a transformer callback that is run when the value of the decorated
 * property, or any of the properties in the watching array, changes. The
 * result of the transformer is assigned to the decorated property.
 */
